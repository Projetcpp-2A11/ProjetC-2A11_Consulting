...
""));
        ...
        employeWidget = new EmployeWidget(tab_employe);
...
"}"));
        ...
        widget->setGeometry(QRect(0, 0, 1331, 621));
...
""));
        ...
        groupBox_prediction_result->setGeometry(QRect(0, 190, 931, 281));
        ...
        label_predicted_duration->setGeometry(QRect(20, 70, 411, 71));
        label_predicted_duration->setStyleSheet(QString::fromUtf8("font-size: 16px; color: #1a4d2e; background: #eafaf1; border-radius: 6px; padding: 4px;"));
        label_predicted_duration->setAlignment(Qt::AlignmentFlag::AlignCenter);
        label_risk = new QLabel(groupBox_prediction_result);
        label_risk->setObjectName("label_risk");
        label_risk->setGeometry(QRect(20, 160, 411, 131));
        label_risk->setStyleSheet(QString::fromUtf8("font-size: 16px; color: #b36b00; background: #fffbe6; border-radius: 6px; padding: 4px;"));
        label_risk->setAlignment(Qt::AlignmentFlag::AlignCenter);
        label_advice = new QLabel(groupBox_prediction_result);
        label_advice->setObjectName("label_advice");
        label_advice->setGeometry(QRect(450, 60, 671, 361));
        label_advice->setStyleSheet(QString::fromUtf8("font-size: 16px; color: #004080; background: #e6f0ff; border-radius: 6px; padding: 4px;"));
        label_advice->setAlignment(Qt::AlignmentFlag::AlignLeading|Qt::AlignmentFlag::AlignLeft|Qt::AlignmentFlag::AlignTop);
        ...
        gridLayout->addWidget(groupBox_prediction_form, 0, 0, 1, 1);
...
"border-radius:9px;"));
        pushButton_employe = new QPushButton(widget_5);
        pushButton_employe->setObjectName("pushButton_employe");
        pushButton_employe->setGeometry(QRect(15, 10, 91, 29));
        pushButton_employe->setFont(font2);
        pushButton_employe->setStyleSheet(QString::fromUtf8("QPushButton {\n"
"    background: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:1,\n"
"                                stop:0 rgba(170, 255, 153, 200), \n"
"                                stop:1 rgba(153, 204, 255, 200));\n"
"    color: #4A4A4A;\n"
"    border-radius: 10px;\n"
"    border: 1px solid rgba(74, 74, 74, 50);\n"
"    padding: 8px 15px;\n"
...
"border-radius:9px;"));
        ...
        label_6->setPixmap(QPixmap(QString::fromUtf8(":/Tools Interface/mon_icone.png")));
    ...
    void retranslateUi(QMainWindow *MW_projet)
    {
        ...
        tabWidget->setTabText(tabWidget->indexOf(tab_employe), QCoreApplication::translate("MW_projet", "Gestion Employ\303\251s", nullptr));
        ...
        label_predicted_duration->setText(QString());
        label_risk->setText(QString());
        label_advice->setText(QString());
        ...
        pushButton_employe->setText(QCoreApplication::translate("MW_projet", "Employ\303\251s", nullptr));
