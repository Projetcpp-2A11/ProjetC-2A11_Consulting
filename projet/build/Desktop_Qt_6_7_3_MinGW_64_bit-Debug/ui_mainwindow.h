...
public:
    ...
    QWidget *tab_4;
    QGroupBox *gb_pdf;
    QTableView *table_pdf_col;
    QPushButton *pb_pdf_col;
    QWidget *Calender;
    ...
    QWidget *tab_3;
    QLabel *label_6;
    QLabel *lab_id_supp_2;
    QLineEdit *le_id_supp_col_2;
    QPushButton *pb_supprimer_col_2;
    QLabel *label_15;
    QWidget *tab_5;
    QLabel *label_16;
...
"color: rgb(12, 12, 12);"));
        ...
        lineEdit_nom_vac = new QLineEdit(widget);
...
"color: rgb(12, 12, 12);"));
        ...
        label_18->setGeometry(QRect(260, 150, 121, 31));
...
"color: rgb(13, 13, 13);"));
        ...
        tabWidget_2 = new QTabWidget(tabWidgetPage4);
        tabWidget_2->setObjectName("tabWidget_2");
        tabWidget_2->setGeometry(QRect(0, 0, 871, 551));
        tab = new QWidget();
        tab->setObjectName("tab");
        label_19 = new QLabel(tab);
        label_19->setObjectName("label_19");
        label_19->setGeometry(QRect(30, 20, 901, 471));
        label_19->setStyleSheet(QString::fromUtf8("background-color: rgb(213, 241, 240);"));
        tableView = new QTableView(tab);
        tableView->setObjectName("tableView");
        tableView->setGeometry(QRect(180, 151, 651, 291));
        label_10 = new QLabel(tab);
        label_10->setObjectName("label_10");
        label_10->setGeometry(QRect(380, 0, 151, 51));
        label_10->setStyleSheet(QString::fromUtf8("background-color: rgb(5, 105, 107);"));
        comboBox = new QComboBox(tab);
        comboBox->addItem(QString());
        comboBox->addItem(QString());
        comboBox->setObjectName("comboBox");
        comboBox->setGeometry(QRect(400, 90, 141, 28));
        comboBox->setStyleSheet(QString::fromUtf8("background-color: rgb(255, 255, 255);\n"
"color: rgb(0, 0, 0);"));
        pushButton = new QPushButton(tab);
        pushButton->setObjectName("pushButton");
        pushButton->setGeometry(QRect(60, 200, 83, 29));
        tabWidget_2->addTab(tab, QString());
        tab_2 = new QWidget();
        tab_2->setObjectName("tab_2");
        label_20 = new QLabel(tab_2);
        label_20->setObjectName("label_20");
        label_20->setGeometry(QRect(-10, 10, 901, 471));
        label_20->setStyleSheet(QString::fromUtf8("background-color: rgb(213, 241, 240);"));
        label_5 = new QLabel(tab_2);
        label_5->setObjectName("label_5");
        label_5->setGeometry(QRect(330, 0, 151, 51));
        label_5->setStyleSheet(QString::fromUtf8("background-color: rgb(5, 105, 107);"));
        tableView_2 = new QTableView(tab_2);
        tableView_2->setObjectName("tableView_2");
        tableView_2->setGeometry(QRect(180, 140, 651, 291));
        pushButton_2 = new QPushButton(tab_2);
        pushButton_2->setObjectName("pushButton_2");
        pushButton_2->setGeometry(QRect(30, 200, 83, 29));
        pushButton_3 = new QPushButton(tab_2);
        pushButton_3->setObjectName("pushButton_3");
        pushButton_3->setGeometry(QRect(30, 270, 83, 29));
        lineEdit_3 = new QLineEdit(tab_2);
        lineEdit_3->setObjectName("lineEdit_3");
        lineEdit_3->setGeometry(QRect(380, 90, 113, 28));
        label_13 = new QLabel(tab_2);
        label_13->setObjectName("label_13");
        label_13->setGeometry(QRect(250, 90, 63, 20));
        tabWidget_2->addTab(tab_2, QString());
        tab_4 = new QWidget();
        tab_4->setObjectName("tab_4");
        gb_pdf = new QGroupBox(tab_4);
        gb_pdf->setObjectName("gb_pdf");
        gb_pdf->setGeometry(QRect(40, 10, 811, 441));
        table_pdf_col = new QTableView(gb_pdf);
        table_pdf_col->setObjectName("table_pdf_col");
        table_pdf_col->setGeometry(QRect(20, 20, 781, 301));
        table_pdf_col->setStyleSheet(QString::fromUtf8("background-color: rgb(254, 255, 255);\n"
""));
        pb_pdf_col = new QPushButton(gb_pdf);
        pb_pdf_col->setObjectName("pb_pdf_col");
        pb_pdf_col->setGeometry(QRect(370, 350, 131, 61));
        pb_pdf_col->setStyleSheet(QString::fromUtf8("background-color: rgb(231,255,200);"));
        ...
        label_6->setGeometry(QRect(130, 40, 631, 431));
        label_6->setStyleSheet(QString::fromUtf8("background-color: rgb(213, 241, 240);"));
        lab_id_supp_2 = new QLabel(tab_3);
        lab_id_supp_2->setObjectName("lab_id_supp_2");
        lab_id_supp_2->setGeometry(QRect(200, 140, 111, 51));
        lab_id_supp_2->setStyleSheet(QString::fromUtf8("background-color: rgb(5, 105, 107);"));
        le_id_supp_col_2 = new QLineEdit(tab_3);
        le_id_supp_col_2->setObjectName("le_id_supp_col_2");
        le_id_supp_col_2->setGeometry(QRect(340, 140, 351, 61));
        le_id_supp_col_2->setStyleSheet(QString::fromUtf8("background-color: rgb(254, 255, 255);"));
        pb_supprimer_col_2 = new QPushButton(tab_3);
        pb_supprimer_col_2->setObjectName("pb_supprimer_col_2");
        pb_supprimer_col_2->setGeometry(QRect(390, 290, 161, 71));
        pb_supprimer_col_2->setStyleSheet(QString::fromUtf8("background-color: rgb(254, 255, 255);"));
        label_15 = new QLabel(tab_3);
        label_15->setObjectName("label_15");
        label_15->setGeometry(QRect(380, 20, 151, 51));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        tabWidget->setTabText(tabWidget->indexOf(widget), QCoreApplication::translate("MainWindow", "Ajouter un rendez-vous", nullptr));
        ...
        label_10->setText(QCoreApplication::translate("MainWindow", "<html><head/><body><p align=\"center\"><span style=\" font-weight:700;\">Trier</span></p></body></html>", nullptr));
        comboBox->setItemText(0, QCoreApplication::translate("MainWindow", "Ascendant", nullptr));
        comboBox->setItemText(1, QCoreApplication::translate("MainWindow", "Descandent", nullptr));

        pushButton->setText(QCoreApplication::translate("MainWindow", "Trier", nullptr));
        tabWidget_2->setTabText(tabWidget_2->indexOf(tab), QCoreApplication::translate("MainWindow", "Trier", nullptr));
        label_20->setText(QString());
        label_5->setText(QCoreApplication::translate("MainWindow", "<html><head/><body><p align=\"center\"><span style=\" font-size:14pt; font-weight:700;\">Recherche</span></p><p align=\"center\"><br/></p></body></html>", nullptr));
        pushButton_2->setText(QCoreApplication::translate("MainWindow", "Rechercher", nullptr));
        pushButton_3->setText(QCoreApplication::translate("MainWindow", "Trier", nullptr));
        label_13->setText(QCoreApplication::translate("MainWindow", "TextLabel", nullptr));
        tabWidget_2->setTabText(tabWidget_2->indexOf(tab_2), QCoreApplication::translate("MainWindow", "Recherche", nullptr));
        gb_pdf->setTitle(QCoreApplication::translate("MainWindow", "PDF", nullptr));
        pb_pdf_col->setText(QCoreApplication::translate("MainWindow", "Exporter en PDF", nullptr));
        tabWidget_2->setTabText(tabWidget_2->indexOf(tab_4), QCoreApplication::translate("MainWindow", "pdf", nullptr));
        ...
        lab_id_supp_2->setText(QCoreApplication::translate("MainWindow", "Identifiant", nullptr));
        pb_supprimer_col_2->setText(QCoreApplication::translate("MainWindow", "Supprimer", nullptr));
        label_15->setText(QCoreApplication::translate("MainWindow", "<html><head/><body><p align=\"center\"><span style=\" font-weight:700;\">Suppression</span></p></body></html>", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(tab_3), QCoreApplication::translate("MainWindow", "suppression", nullptr));
