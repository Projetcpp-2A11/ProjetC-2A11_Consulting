...
"border-radius:9px;"));
        ...
        label_4->setPixmap(QPixmap(QString::fromUtf8("../Tools Interface/user-tie-solid.svg")));
...
"border-radius:9px;"));
        ...
        label_7->setPixmap(QPixmap(QString::fromUtf8("../Tools Interface/circle-user-solid.svg")));
...
"border-radius:9px;"));
        ...
        label_8->setPixmap(QPixmap(QString::fromUtf8("../Tools Interface/right-from-bracket-solid.svg")));
        ...
        tabWidget->setGeometry(QRect(230, 90, 1331, 691));
...
"}"));
        ...
        label_32->setGeometry(QRect(30, 520, 241, 21));
        label_32->setFont(font3);
        comboBox_2 = new QComboBox(widget_3);
        comboBox_2->addItem(QString());
        comboBox_2->setObjectName("comboBox_2");
        comboBox_2->setGeometry(QRect(360, 580, 171, 26));
...
"}"));
        ...
        label_35->setGeometry(QRect(90, 580, 241, 21));
        label_35->setFont(font3);
        pushButton_supprimer = new QPushButton(widget_3);
        pushButton_supprimer->setObjectName("pushButton_supprimer");
        pushButton_supprimer->setGeometry(QRect(560, 570, 121, 41));
...
"}"));
        ...
        pushButton_annuler->setGeometry(QRect(1178, 470, 131, 32));
        QFont font5;
...
""));
        ...
        pushButton_ajouter->setGeometry(QRect(1083, 470, 88, 32));
...
"}"));
    ...
    void retranslateUi(QMainWindow *MW_projet)
    {
        ...
        ___qtablewidgetitem->setText(QCoreApplication::translate("MW_projet", "ID", nullptr));
        QTableWidgetItem *___qtablewidgetitem1 = tableWidget->horizontalHeaderItem(1);
        ___qtablewidgetitem1->setText(QCoreApplication::translate("MW_projet", "Nom-Projet", nullptr));
        QTableWidgetItem *___qtablewidgetitem2 = tableWidget->horizontalHeaderItem(2);
        ___qtablewidgetitem2->setText(QCoreApplication::translate("MW_projet", "Complexit\303\251", nullptr));
        QTableWidgetItem *___qtablewidgetitem3 = tableWidget->horizontalHeaderItem(3);
        ___qtablewidgetitem3->setText(QCoreApplication::translate("MW_projet", "Statue", nullptr));
        QTableWidgetItem *___qtablewidgetitem4 = tableWidget->horizontalHeaderItem(4);
        ___qtablewidgetitem4->setText(QCoreApplication::translate("MW_projet", "Budget", nullptr));
        QTableWidgetItem *___qtablewidgetitem5 = tableWidget->horizontalHeaderItem(5);
        ___qtablewidgetitem5->setText(QCoreApplication::translate("MW_projet", "Nom-Client", nullptr));
        ...
        label_32->setText(QCoreApplication::translate("MW_projet", "Supprimer Un Projet ", nullptr));
        comboBox_2->setItemText(0, QCoreApplication::translate("MW_projet", "ID", nullptr));

        label_35->setText(QCoreApplication::translate("MW_projet", "Choisir l'ID de Projet", nullptr));
